    ...
    <div className="h-screen w-screen bg-gradient-to-br from-rose-50 via-red-50 to-amber-50 flex items-center justify-center p-0">
      ...
      <div className="h-full w-full md:h-[90vh] md:max-h-[700px] md:w-[90vw] md:max-w-5xl bg-white shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="relative h-32x w-full md:hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-4">
            <h1 className="text-2xl font-bold text-white">
              {role === "DONOR" ? "Save Lives Today" : "Connect With Donors"}
            </h1>
          </div>
        </div>
            ...
            <div>
              <h1 className="text-4xl font-bold text-white mb-4">
                {role === "DONOR"
                  ...
                  : "Connect with Lifesavers"}
              </h1>
              <p className="text-lg text-white/90">
                {role === "DONOR"
                  ? "Your blood donation can save up to 3 lives. Join our community of heroes today."
                  : "Access our network of committed blood donors to save lives in your community."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-6 md:p-8 overflow-y-auto">
          ...
          {/* Google Sign-In - Same height as submit button */}
          <Button
            variant="outline"
